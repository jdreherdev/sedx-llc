  ...
  if (rawMetrics) {
    try {
      ...
      for (const app of doc.apps || []) {
        ...
        if (mx) app.metrics = { activeInstalls: mx.activeInstalls, totalInstalls: mx.totalInstalls, rating: mx.rating, ratingCount: mx.ratingCount, mrr: mx.mrr, revenue: mx.revenue, subs: mx.subs };
      }
